...
The tree below lists the current repository-level structure and the main verified subfolders. Runtime folders generated by validation runs, such as `validation/cache/` and `validation/results/`, are intentionally not listed.
